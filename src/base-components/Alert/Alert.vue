...
// Soft Color
const softPrimary = [
  'bg-primary border-primary border-opacity-5 text-primary', // Default
  'dark:border-opacity-100 dark:border-primary' // Dark mode
]
const softSecondary = [
...
const softSuccess = [
  'bg-notification-success-light text-notification-success border-success border-opacity-5', // Default
  'dark:border-success dark:border-opacity-20' // Dark mode
]
const softWarning = [
  'bg-warning border-warning border-opacity-5 text-warning', // Default
  'dark:border-warning dark:border-opacity-20' // Dark mode
]
const softPending = [
  'bg-pending border-pending border-opacity-5 text-pending', // Default
  'dark:border-pending dark:border-opacity-20' // Dark mode
]
const softDanger = [
  'bg-notification-error-light text-notification-error border-opacity-5', // Default
  'dark:border-danger dark:border-opacity-20' // Dark mode
]
const softDark = [
  'bg-dark border-dark border-opacity-5 text-dark', // Default

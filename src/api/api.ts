...
export class ApiResponse implements Response {
  constructor(public code: number, public msg: string | null, public data: object | null) { }
}
...
export const patchRequest = async (endpoint: string, data: object, authType: AuthType) => {
    try {
        instance.defaults.headers.common['Content-Type'] = 'application/json';        
...
export const fileUploadRequest = async (endpoint: string, file: File, authType: AuthType ,resolve:any|null) => {
  try {

  ...
  <div class="flex justify-start">
    <div class="mr-5 mt-5 w-1/2">
      <div class="w-full rounded-xl bg-white dark:bg-darkmode-600">
        ...
        >
          <div class="text-lg font-bold">薪資小工具</div>
    ...
    <div class="mr-5 mt-5 w-1/2">
      <div class="w-full rounded-xl bg-white dark:bg-darkmode-600">
        <div
          class="flex items-center justify-between border-b border-slate-200 p-4"
        >
          <div class="text-lg font-bold">勞報單系統</div>
    ...
    <div class="mr-5 mt-5">
      <div class="w-full rounded-xl bg-white dark:bg-darkmode-600">
        <div
          class="flex items-center justify-between border-b border-slate-200 p-4"
        >
          <div class="text-lg font-bold">最新消息</div>
        </div>
        <div class="cursor-pointer p-4">
          全新雲端秘書系統！<br />
          對系統不熟悉嗎？<br />
    ...
    <div class="mr-5 mt-5">
      <div class="w-full rounded-xl bg-white dark:bg-darkmode-600">
        <div
          class="flex items-center justify-between border-b border-slate-200 p-4"
        >
          <div class="text-lg font-bold">薪資小工具-教學影片</div>
        </div>
        <div class="cursor-pointer p-4"></div>
      </div>
    </div>
  </div>
